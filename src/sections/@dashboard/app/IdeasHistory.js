...
export const IdeasHistory = () => {
  ...
  const jwtToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2OTY1MTA1NjIsImlzcyI6Imh0dHA6Ly9sb2NhbGhvc3Q6NzE0OCIsImF1ZCI6Imh0dHA6Ly9sb2NhbGhvc3Q6NzE0OCJ9.8Gaav9KzbTPGBqLoMG5oin7McIKSFO-Y6YT25fanofw';
  ...
  return (
    ...
    <div className="flex-grow-0 flex-shrink-0 w-full h-[196px] rounded-2xl bg-cover bg-no-repeat bg-center border border-[#eaecf0]" 
      ...
      {/* idea card */}
      {data.map((idea, id) => (
        <div key={id} className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-full gap-6 px-6 pt-6 pb-7 rounded-2xl bg-white border border-[#eaecf0] hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <div className="flex flex-col justify-start items-start flex-grow relative gap-1">
                ...
                <div className="flex flex-row justify-start items-center self-stretch flex-grow-0 flex-shrink-0 h-7 relative gap-2 ">
                  <p className="flex-grow-0 flex-shrink-0 text-sm text-left text-[#101828]">
                    <span
                      className="flex-grow-0 flex-shrink-0 text-sm font-semibold text-left text-[#101828] gap-2 sm:gap-2"
                    >
                      Ticket
                    </span>
