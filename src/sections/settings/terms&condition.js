...
export const Notifications = () => {
  ...
  <div className="flex flex-col justify-start items-center self-stretch flex-grow-0 flex-shrink-0 gap-16 pb-24">
    <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-full gap-16 px-8">
        ...
        <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-full">
          <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative">
            <p className="self-stretch flex-grow-0 flex-shrink-0 w-full text-lg text-left text-[#475467]">
              <span className="self-stretch flex-grow-0 flex-shrink-0 w-w-full text-lg text-left text-[#475467]">
              ...
              <br />
              <span className="self-stretch flex-grow-0 flex-shrink-0 w-full text-lg text-left text-[#475467]">
          ...
          <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative">
            ...
            <p className="self-stretch flex-grow-0 flex-shrink-0 w-full text-3xl font-semibold text-left text-[#101828]">
          ...
          <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative">
            ...
            <p className="self-stretch flex-grow-0 flex-shrink-0 w-full text-2xl font-semibold text-left text-[#101828]">
