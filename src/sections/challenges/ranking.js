          ...
          <td className="px-6 py-4">1.</td>
            ...
            <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
              ...
              <div className="pl-3">
                ...
                <div className="font-normal text-gray-500">Customer Support</div>
              </div>
            </th>
          ...
          <td className="px-6 py-4">2.</td>
            ...
            >
              ...
              <div className="pl-3">
                ...
                <div className="font-normal text-gray-500">P&D</div>
              </div>
            </th>
          ...
          <td className="px-6 py-4">3.</td>
            ...
            >
              ...
              <div className="pl-3">
                ...
                <div className="font-normal text-gray-500">Life Insurance</div>
              </div>
            </th>
