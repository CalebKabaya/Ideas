...
export default function ChallengesList() {
  ...
  return (
    <div className="flex flex-col justify-start items-start gap-6">
      ...
      >
        <div
          className="flex-grow-0 flex-shrink-0 lg:w-[200px] md:w-[200px] sm:w-[200px] xs:w-[120px] h-36 relative overflow-hidden rounded-lg  bg-cover bg-no-repeat bg-center"
        ...
        <div className="flex justify-center items-center flex-grow-0 flex-shrink-0 relative overflow-hidden lg:visible md:visible xs:invisible gap-2">
          <p className="flex-grow-0 flex-shrink-0 text-xs font-bold text-left text-[#026aa2]">View Challenge</p>
          <svg
            width={20}
            height={20}
